...
9. 风格清晰、克制、专业，避免空话。`;
export function buildDraftMessages({ sourceText, contact, role }) {
...
export function buildRoleSuggestionMessages(input) {
...
export function buildRoleRecognitionMessages({ roleLabel }) {
    return [
        {
            role: 'system',
